...
class TheKarte {
    ...
    */
    constructor(styleCreator, styleColorCreator) {
    ...
    */
    setup(keyboardMenu, importHandler, userFeedbackCallback, parentElement, keyEventEmitter, pasteEventEmitter) {
    ...
    */
    layerActive_addFeatures(features) {
    ...
    */
    featuresFilterByLayer(layerFeatureIndex, layerFilterIndex, isInside) {
